...
export const initialConfig: PoolConfig = {
  ...
  core: "Semi-hardwood",
  face: "Okoume",
  bond: "Factory specification pending",
...
export function demoSeed(): StoreData {
  return {
    categories: [
      {
        ...
        slug: "oem-plywood",
        description:
          "Fixed, curated MR and BWP plywood slots for cabinetry, interior fit-outs and retail stock.",
      ...
      },
      {
        ...
        description:
          "Everyday interior applications. Categories and supplier specifications are managed by PLYDECK.",
        image_url: "/plywood-studio.png",
        active: true,
      },
      {
        ...
        slug: "marine-plywood",
        description:
          "Explore marine-grade products as verified supplier specifications become available.",
        image_url: "/plywood-studio.png",
        active: true,
      },
    ],
    shipments: [
      {
        id: SHIPMENT_ID,
        name: "Kerala → Bengaluru · combined load",
    ...
    pools: [1, 2].map((i) => ({
      id: i === 1 ? POOL_ONE : POOL_TWO,
      code: `BLR-OEM-00${i}`,
      name: i === 1 ? "OEM collective · Pool 01" : "OEM collective · Pool 02",
      category_id: OEM_CATEGORY,
    ...
    whatsapp: {
      enabled: false,
      configured: false,
      reason: "Demo mode — no messages are sent.",
    },
  };
}
