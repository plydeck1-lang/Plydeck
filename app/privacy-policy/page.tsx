...
export default function PrivacyPolicyPage() {
  return (
    ...
    >
      <section><h2>1. Information we collect</h2><p>We may collect account identifiers, business and tax-registration details, billing and delivery addresses, contact information, pool and order activity, support communications, consent choices, security logs and basic device or browser information needed to protect and operate the service.</p></section>
