...
export const metadata: Metadata = {
  ...
  description: "How PLYDECK handles business account, order, payment and communication data.",
};
...
export default function PrivacyPolicyPage() {
  return (
    <PolicyShell
      ...
      intro="This policy describes the information PLYDECK uses to operate business accounts, pooled orders, payments, fulfilment and optional WhatsApp notifications."
    >
      <section><h2>1. Information we collect</h2><p>We may collect account identifiers, business and GST details, billing and delivery addresses, contact information, pool and order activity, payment references and status, support communications, consent choices, security logs and basic device or browser information needed to protect and operate the service.</p></section>
      <section><h2>2. Why we use it</h2><p>Information is used to authenticate users, verify business details, prepare quotations and invoices, reserve slots, process and reconcile payments, coordinate suppliers and logistics, perform quality and delivery administration, prevent fraud, provide support and meet tax, accounting and legal obligations.</p></section>
      <section><h2>3. Service providers and disclosures</h2><p>PLYDECK uses specialist providers for hosting, database and authentication, payment processing and opted-in business messaging. Relevant information is shared only to the extent required for those services, order fulfilment, legal compliance or protection of the platform and its users. Supplier and logistics partners may receive the business and order details necessary to fulfil a confirmed order.</p></section>
      <section><h2>4. Payments</h2><p>Payment checkout is handled by the connected payment gateway. PLYDECK stores transaction references, amounts and status required for reconciliation and refunds, but does not store full card or banking credentials entered into the gateway.</p></section>
