...
export default function ShippingPolicyPage() {
  return (
    ...
    >
      ...
      <section><h2>4. QC and dispatch</h2><p>PLYDECK records the agreed QC update before requesting the final 50%. Dispatch requires cleared full payment and supplier release. A QC update does not replace the buyer’s obligation to inspect visible condition and quantity at handover.</p></section>
