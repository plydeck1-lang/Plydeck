...
export default function RefundPolicyPage() {
  return (
    <PolicyShell
      ...
      intro="PLYDECK does not collect online payment to reserve a slot. This policy explains when a direct reservation is released and how waiting-list replacement works."
    >
      <section><h2>1. PLYDECK cancellation</h2><p>If PLYDECK cancels an underfilled pool, cannot procure the confirmed specification, or cancels because of supplier or QC failure, all affected reservations are released and buyers are notified. No online payment is collected for a reservation, so there is no gateway refund to process.</p></section>
      <section><h2>2. Buyer cancellation while pool is open</h2><p>A buyer may cancel while the pool is live or confirming. The order is marked cancelled, the slot is released immediately and the next waiting-list buyer may be offered that slot.</p></section>
