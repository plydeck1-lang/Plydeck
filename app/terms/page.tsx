...
export default function TermsPage() {
  return (
    ...
    >
      ...
      <section><h2>4. Price, GST and offline payments</h2><p>The accepted order summary shows the four plywood rate lines, taxable value, GST and total. No online payment gateway is used. PLYDECK operations manually records verified offline receipts in three stages: 10% booking, a further 40% before pool confirmation, and the final 50% after QC and before dispatch. Your order view shows the amount confirmed and balance.</p></section>
