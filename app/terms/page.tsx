...
export default function TermsPage() {
  return (
    ...
    >
      ...
      <section><h2>4. Price and GST</h2><p>The accepted order summary shows the four plywood rate lines, taxable value, GST and total. No online payment or payment gateway is required to reserve a slot. Any invoicing or commercial settlement after reservation is handled through the agreed business order process.</p></section>
      <section><h2>5. Pool confirmation and supplier commitment</h2><p>A pool may be confirmed when all required slots are directly reserved and the supplier accepts the order. PLYDECK may extend an underfilled pool, move a consenting buyer to a replacement pool, or cancel where commercial, supplier, transport or quality conditions cannot be met.</p></section>
