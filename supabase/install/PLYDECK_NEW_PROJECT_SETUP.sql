...
-- Includes migrations 001 through 010 and the seed. Run the ENTIRE file once.
...
-- Included file: 005_independent_thickness_quantities.sql
...
-- Included file: 006_fixed_100_sheet_slot_mix.sql
...
-- Included file: 007_fixed_four_item_slot.sql
...
-- Included file: 008_direct_slot_reservations.sql
...
-- Included file: 009_admin_slot_blocks_manual_payments.sql
...
-- Included file: 010_final_rate_card_pricing.sql
...
-- Each slot has the fixed four-item, 100-sheet composition. Initial final rate-card values are ₹56/sqft.
-- Replace pending specs, rates and dates in admin before publishing.
insert into public.categories(id,name,slug,description,image_url,active)values('11111111-1111-4111-8111-111111111111','OEM Plywood','oem-plywood','Fixed, curated MR and BWP plywood slots for cabinetry, interior fit-outs and retail stock.','/plywood-studio.png',true)on conflict(id)do nothing;
